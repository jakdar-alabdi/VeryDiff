...
function run_experiments_pool4()
    ...
    # set_neuron_splitting_config((true, false, false), (false, true, false), DeepSplitUnbiased, ZonoContraction, LPZonoContract)
    # run_func(deepsplit_epsilon, get_config())
    
    # set_neuron_splitting_config((true, true, true), (false, true, false), DeepSplitUnbiased, LP)
    # run_func(deepsplit_epsilon, get_config())
    # set_neuron_splitting_config((true, false, false), (false, true, false), DeepSplitUnbiased, LP)
    # run_func(deepsplit_epsilon, get_config())
    
    set_neuron_splitting_config((false, false, false), (false, true, false))
...
function run_experiments_pool5()
    ...
    # run_func(deepsplit_epsilon, get_config())
    # set_neuron_splitting_config((true, false, false), (false, true, true), DeepSplitUnbiased, ZonoContraction, LPZonoContract)
    # run_func(deepsplit_epsilon, get_config())
    
    # set_neuron_splitting_config((true, true, true), (false, true, true), DeepSplitUnbiased, LP)
    # run_func(deepsplit_epsilon, get_config())
    # set_neuron_splitting_config((true, false, false), (false, true, true), DeepSplitUnbiased, LP)
    # run_func(deepsplit_epsilon, get_config())
    
    set_neuron_splitting_config((false, false, false), (false, true, true))
    run_func(verydiff_epsilon, get_config())
end
